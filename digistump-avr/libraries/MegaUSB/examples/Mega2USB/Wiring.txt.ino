...
...So you're looking at anywhere up to 0.5mS from changing the clk pin, 
...
On a 3-Button controller:
  ...
  L, R, A, C, B, S, are wired to the DB9 via a TTL multiplexer
...
and group 4 DB9 Inputs (ie. {1,2,6,9}) to a single analogue GPIO pin
...
and group 2 DB9 Inputs to a single analogue GPIO pin
